...
MIN_NUMBER_OF_SHOPS = 15
MAX_NUMBER_OF_SHOPS = 20
...
def filter_and_sort_shops(input_file, output_file, min_reviews=200):
    ...
    reviews_file = f'min_num_of_reviews.txt'
...
if __name__ == "__main__":
    input_file = "massage_ratings_with_embeds.csv"
    output_file = f"top_rated_massage_shops.csv"
