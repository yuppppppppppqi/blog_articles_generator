...
def process_csv():
    input_file = "massage_ratings_in_one_area_replaced.csv"
    output_file = "massage_ratings_with_embeds.csv"
...
if __name__ == "__main__":
    process_csv()
    print("Processing complete! Check massage_ratings_with_embeds.csv for results.") 