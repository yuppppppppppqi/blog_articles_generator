...
<figure class="wp-block-image size-full" style="margin-bottom: 20px;">
    <img 
        src="https://my-bangkok-life.com/wp-content/uploads/2025/05/foot-massage-wat-pho-9-junsawang-massage-pratunam.webp"
        alt="foot massage wat pho 9 junsawang massage pratunam"
        class="wp-image-21"
    />
</figure>
<!-- /wp:image -->
...
<!-- /wp:paragraph -->
<p><iframe src='https://www.google.com/maps/embed/v1/place?q=place_id:ChIJObgDLHaf4jARu1q10hgA9Vs&zoom=17&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8' width='600' height='450' style='border:0' allowfullscreen='' loading='lazy' referrerpolicy='no-referrer-when-downgrade'></iframe></p>"""
