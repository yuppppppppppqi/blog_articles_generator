...
<figure class="wp-block-image size-full" style="margin-bottom: 20px;">
    <img 
        src="https://my-bangkok-life.com/wp-content/uploads/2025/05/foot-chiang-rai-3-chiangrai-rising-sun-massage.webp"
        alt="foot chiang rai 3 chiangrai rising sun massage"
        class="wp-image-21"
    />
</figure>
<!-- /wp:image -->
...
<!-- /wp:paragraph -->
<p><iframe src='https://www.google.com/maps/embed/v1/place?q=place_id:ChIJgXJhu-EH1zARCdS05zMnV04&zoom=17&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8' width='600' height='450' style='border:0' allowfullscreen='' loading='lazy' referrerpolicy='no-referrer-when-downgrade'></iframe></p>"""
