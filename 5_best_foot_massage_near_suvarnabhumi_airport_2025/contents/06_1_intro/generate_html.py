...
<figure class="wp-block-image size-full" style="margin-bottom: 20px;">
    <img 
        src="https://my-bangkok-life.com/wp-content/uploads/2025/05/foot-massage-suvarnabhumi-airport-6-roma-massage-spa.webp"
        alt="foot massage suvarnabhumi airport 6 roma massage spa"
        class="wp-image-21"
    />
</figure>
<!-- /wp:image -->
...
<!-- /wp:paragraph -->
<p><iframe src='https://www.google.com/maps/embed/v1/place?q=place_id:ChIJGXGXXQCh4jARi4h3q0N_75E&zoom=17&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8' width='600' height='450' style='border:0' allowfullscreen='' loading='lazy' referrerpolicy='no-referrer-when-downgrade'></iframe></p>"""
